...
class BuildMatrixWithConditionsTest {
    ...
    fun case_1() {
        ...
        val expected = arrayOf(intArrayOf(3, 0, 0), intArrayOf(0, 0, 1), intArrayOf(0, 2, 0))
    ...
    fun case_2() {
        val k = 3
        val rowConditions = arrayOf(intArrayOf(1, 2), intArrayOf(2, 3), intArrayOf(3, 1), intArrayOf(2, 3))
